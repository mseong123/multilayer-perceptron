...
def main()->None:
    ...
    loss_train, loss_valid, accuracy_train, accuracy_valid = model.fit(df_train.values, df_valid.values, y_train, y_valid, batch_size=16, epoch=30, _lambda=3, L2regularization=False, early_stopping=False, optimizer=None)
